...
const About: NextPage = () => {
  return (
    ...
    <div className="min-h-screen flex flex-col bg-black text-white">
      ...
      <main className="flex flex-col items-center justify-center flex-grow pt-28 p-8">
        <h1 className="text-5xl font-extrabold text-white mb-8 text-center">
          Sobre Mim
        </h1>
        <div className="max-w-3xl text-lg text-gray-300 text-center leading-relaxed space-y-6">
          <p>
        ...
        <nav className="mt-12">
          <Link href="/" legacyBehavior>
            <a className="inline-block text-white bg-blue-600 py-3 px-8 rounded-lg hover:bg-blue-700 shadow-lg transition duration-300">
